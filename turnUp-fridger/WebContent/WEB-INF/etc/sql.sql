...
CREATE TABLE FRIDGER (
   FRIDGE_ID NUMBER PRIMARY KEY, /* 냉장고ID */
   FRIDGE_NAME VARCHAR2(30) NOT NULL /* 냉장고애칭 */
);
CREATE SEQUENCE FRIDGE_ID INCREMENT BY 1 START WITH 1;  
DROP SEQUENCE FRIDGE_ID;
SELECT FRIDGE_ID.NEXTVAL FROM DUAL;

/* 냉장고공용그룹 */
DROP TABLE FRIDGE_GROUP;
DELETE FROM FRIDGE_GROUP;
CREATE TABLE FRIDGE_GROUP (
   GROUP_KEY NUMBER PRIMARY KEY, /* 공용그룹KEY */
   GROUP_JOIN_SEQ NUMBER NOT NULL, /* 그룹가입순서 */
   MEMBER_ID VARCHAR2(20) NOT NULL, /* 회원ID */
   FRIDGE_ID NUMBER, /* 냉장고ID */
   CONSTRAINT FRIDGE_GROUP_MEMBER_ID_FK FOREIGN KEY(MEMBER_ID) REFERENCES MEMBER,
   CONSTRAINT FRIDGE_GROUP_FRIDGE_ID_FK FOREIGN KEY(FRIDGE_ID) REFERENCES FRIDGER
);
...
CREATE TABLE MY_IRDNTS (
   ...
   FRIDGE_ID NUMBER NOT NULL, /* 냉장고ID */
   CONSTRAINT MY_IRDNTS_IRDNT_ID_FK FOREIGN KEY(IRDNT_ID) REFERENCES IRDNT_MANAGE,
   CONSTRAINT MY_IRDNTS_FRIDGE_ID_FK FOREIGN KEY(FRIDGE_ID) REFERENCES FRIDGER
);
